            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                {examDetails.map((detail, index) => detail && (
                  <Badge key={index} variant="secondary" className="px-3 py-1 bg-primary-foreground/20 text-primary-foreground transition-all hover:bg-primary-foreground/30 hover:scale-105">
