...
import { MoreVertical, Pen, Trash2, Link as LinkIcon, PlusCircle, Edit, ExternalLink, Copy, GripVertical } from 'lucide-react';
    ...
    return (
        <>
            <div ref={setNodeRef} style={style}>
                <Card className={cn("flex flex-col overflow-hidden rounded-lg shadow-lg transition-all duration-300 hover:shadow-xl bg-card border-border/50 group", isDragging ? 'shadow-2xl -translate-y-1' : 'hover:-translate-y-1')}>
                    <div className="relative aspect-video w-full overflow-hidden">
                        ...
                        <div className="absolute top-2 right-2 flex items-center gap-1">
                             <Button
                                variant="ghost"
                                size="icon"
                                className="h-8 w-8 rounded-full bg-primary/80 text-primary-foreground backdrop-blur-sm hover:bg-primary hover:text-primary-foreground cursor-grab"
                                {...attributes}
                                {...listeners}
                            >
