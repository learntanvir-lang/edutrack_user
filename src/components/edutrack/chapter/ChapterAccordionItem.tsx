...
function ChapterAccordionItem({ chapter, subjectId, paperId }: ChapterAccordionItemProps) {
    ...
    return (
        <>
            <div className="bg-card rounded-lg shadow-sm transition-all duration-300 ease-out hover:shadow-xl hover:shadow-primary/20 hover:-translate-y-2 hover:scale-[1.02] [perspective:800px] hover:[transform:translateY(-8px)_scale(1.02)_rotateX(3deg)]">
                    ...
                    <div className="pt-4 space-y-6">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between text-sm font-medium text-muted-foreground">
                                ...
                                <Button variant="outline" size="sm" onClick={() => setIsProgressItemDialogOpen(true)} className="transition-all duration-300 bg-primary text-primary-foreground border-2 border-primary hover:bg-transparent hover:text-primary hover:shadow-lg hover:shadow-primary/20">
                        ...
                        <div className="space-y-3">
                             <div className="flex items-center justify-between text-sm font-medium text-muted-foreground">
                                ...
                                <Button variant="outline" size="sm" onClick={handleAddLink} className="transition-all duration-300 bg-primary text-primary-foreground border-2 border-primary hover:bg-transparent hover:text-primary hover:shadow-lg hover:shadow-primary/20">
                                    <PlusCircle className="mr-2 h-4 w-4" />
                                    Add Resource
                                </Button>
                            </div>
