                        ...
                        <div className="space-y-3">
                            ...
                            <div className="space-y-2">
                                {chapter.resourceLinks.map(link => (
                                     <div key={link.id} className="group/link flex items-center gap-1 rounded-md transition-colors border border-border bg-primary/10 hover:bg-primary/20 hover:border-primary">
